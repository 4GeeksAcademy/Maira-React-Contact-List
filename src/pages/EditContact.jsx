...
const EditContact = () => {
    ...
    useEffect(() => {
        const contactoEditado = store.contactos.find((elemento) => elemento.id == idContact)
        console.log(idContact);
        ...
        <form>
            <div className="container mt-3 text-center">
                ...
                <div className="mb-3 text-start">
                    ...
                    <input type="text" className="form-control" id="Input1" placeholder="Juana Díaz" name="name" value={existingContact.name || ""} onChange={handleChange} />

                    <label htmlFor="Input2" className="form-label">Email</label>
                    <input type="email" className="form-control" id="Input2" placeholder="nombre@ejemplo.com" name="email" value={existingContact.email || ""} onChange={handleChange} />
                    ...
                    <input type="text" className="form-control" id="Input4" placeholder="5555 Calle" name="address" value={existingContact.address || ""} onChange={handleChange} />
